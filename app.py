...
translations = {
    "en": {
        ...
        "upload_prompt": "Upload an image and choose a detection task to compare object detection results (.jpg, .jpeg, .png)",
    ...
    "zh": {
        ...
        "upload_prompt": "請上載一張圖片以比較不同自主訓練模型的結果 (.jpg, .jpeg, .png):",
        ...
        "no_objects": "未偵察到任何物件。",
        "comparison_summary": "性能比較 - {task_name}",
        "no_image_prompt": "點選以上按鈕以展示訓練結果。",
        "task1_button": "比較各個自行訓練模型的性能",
        "task2_button": "比較預設模型與訓練模型的性能",
